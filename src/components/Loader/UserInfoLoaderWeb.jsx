...
import "../Loader/userInfoLoader.css"

const UserInfoLoaderWeb = () => (
    <div className="userInfoLoader" >
  <ContentLoader
    speed={2}
    width={800}
    height={600}
  ...
  >
    {/* {User profile photo} */}
    <rect x="20" y="20" rx="3" ry="3" width="500" height="231" />
...
export default UserInfoLoaderWeb;
