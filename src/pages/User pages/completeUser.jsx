      ...
      <div className="complete-profile-body">
        <form className="profile-form" onSubmit={handleSubmit}>
          <div className="generalData">
            ...
            <Text label={"General Information"} size={"s16"} weight={"bold"} lineheight={"l22"} style={{padding :"17px"}} />
            </label>
            <img src={down} className="img" alt="down-icon" style={isGeneralCollapsed ? {rotate: '0deg'} : {rotate: '180deg'}}/>
            </div>
            <hr />
            {!isGeneralCollapsed && (
              <>
                ...
                <div class="general-data">
                  <label htmlFor="name" className="label-for-fields"><Text label={"First name"} size={"s12"} weight={"regular"} lineheight={"l16"}/></label>
                  <input
                  type="text"
                  name="name"
                  value={formData.name}
                ...
                <div class="general-data">
                  <label className="label-for-fields" htmlFor="lastname"><Text label={"Last name"} size={"s12"} weight={"regular"} lineheight={"l16"}/></label>
                  <input
                  type="text"
                  name="lastname"
                ...
                <div class="general-data">
                  <label className="label-for-fields" htmlFor="headline"><Text label={"Role"} size={"s12"} weight={"regular"} lineheight={"l16"}/></label>
                  <input
                  type="text"
                  name="headline"
          ...
          <div className="education-form">
            <div className="main-label" onClick={() => setIsEducationCollapsed(!isEducationCollapsed)}>
            <label className="labels">
              <Text label={"Educations"} size={"s16"} weight={"bold"} />
            </label>
            <img src={down} className="img" alt="down-icon" style={isEducationCollapsed ? {rotate: '0deg'} : {rotate: '180deg'}}/>
            </div>
            <hr />
              ...
              <>
                {formData.education.map((edu, index) => (
                  <div key={index} className="fields-form">
                    ...
                    <label className="label-for-fields" htmlFor="degree"><Text label={"Degree"} size={"s12"} weight={"regular"} lineheight={"l16"}/></label>
                    <input
                      name="degree"
                      className="update-input-fields"
                      value={edu.degree}
                    ...
                    <div className="education-data">
                    <label className="label-for-fields" htmlFor="institution"><Text label={"Institution"} size={"s12"} weight={"regular"} lineheight={"l16"}/></label>
                    <input
                      name="institution"
                      className="update-input-fields"
                    ...
                    <div className="education-data">
                    <label className="label-for-fields" htmlFor="startDate"> <Text label={"Start Date"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="startDate"
                      type="date"
                      className="update-input-fields"
                    ...
                    /></div>
                    <div className="education-data">
                    <label className="label-for-fields" htmlFor="endDate"> <Text label={"End Date"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="endDate"
                      type="date"
                      className="update-input-fields"
          ...
          <div className="experience-form">
            <div className="main-label" onClick={() => setIsExperienceCollapsed(!isExperienceCollapsed)}>
            <label className="labels">
              <Text label={"Experiences"} size={"s16"} weight={"bold"} />
            </label>
            <img src={down} className="img" alt="down-icon" style={isExperienceCollapsed ? {rotate: '0deg'} : {rotate: '180deg'}}/>
            </div><hr />
              ...
              <>
                {formData.experience.map((exp, index) => (
                  <div key={index} className="fields-form">
                    ...
                    <label className="label-for-fields" htmlFor="position"> <Text label={"Position"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="position"
                      className="update-input-fields"
                      value={exp.position}
                    ...
                    /></div>
                    <div className="experience-data">
                    <label className="label-for-fields" htmlFor="employer"> <Text label={"Employer"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="employer"
                      className="update-input-fields"
                      value={exp.employer}
          ...
          <div className="certifications-form">
            <div className="main-label" onClick={() => setIsCertificationCollapsed(!isCertificationCollapsed)}> 
            <label className="labels">
              <Text label={"Certifications"} size={"s16"} weight={"bold"} />
            </label>
            <img src={down} className="img" alt="down-icon" style={isCertificationCollapsed ? {rotate: '0deg'} : {rotate: '180deg'}}/>
            </div>
            <hr />
              ...
              <>
                {formData.certifications.map((cert, index) => (
                  <div key={index} className="fields-form">
                    ...
                    <label className="label-for-fields" htmlFor="title"> <Text label={"Title"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="title"
                      className="update-input-fields"
                      value={cert.title}
                    ...
                    /></div>
                    <div className="certifications-data">
                    <label className="label-for-fields" htmlFor="organization"> <Text label={"Organization"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="organization"
                      className="update-input-fields"
                    ...
                    /></div>
                    <div className="certifications-data">
                    <label className="label-for-fields" htmlFor="issueDate"> <Text label={"Issue Date"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="issueDate"
                      type="date"
                      className="update-input-fields"
                    ...
                    /></div>
                    <div className="certifications-data">
                    <label className="label-for-fields" htmlFor="expirationDate"> <Text label={"Expiration Date"} size={"s12"} weight={"regular"} lineheight={"l16"}/> </label>
                    <input
                      name="expirationDate"
                      type="date"
                      className="update-input-fields"
        ...
        Add Certification
          ...
          <div className="languages">
            <div className="main-label" onClick={() => setIsLanguageCollapsed(!isLanguageCollapsed)}>
      <label className="labels" > <Text label={"Languages"} size={"s16"} weight={"bold"} /> </label>
      <img src={down} className="img" alt="down-icon" style={isLanguageCollapsed ? {rotate: '0deg'} : {rotate: '180deg'}}/>
      </div><hr />
      {!isLanguageCollapsed && (
        <>
          <div className="inputbox-update">
            ...
            <button
              ...
              onClick={() => {onAddItem('languages', newLanguage);
              setNewLanguage('')}}
            >
          ...
          <div className="tags-div">
              {formData.languages.map((lang, index) => (
                ...
                <div key={index}><Text label={lang} size={"s14"} weight={"regular"} color={'black'} /></div>
                <button
            type="button"
            className="remove-list-button"
            onClick={() => handleRemoveArrayField(index, "languages")}
          > <img className="remove-img" src={X} alt="Remove" /> </button>
                </div>
              ))}
          </div>
          </>
          ...
          <div className="skills-complete">
            ...
            <img src={down} className="img" alt="down-icon" style={isSkillsCollapsed ? {rotate: '0deg'} : {rotate: '180deg'}}/>
            </div><hr />
            {!isSkillsCollapsed && (
              <>
              <div className="inputbox-update">
                ...
                <button
                  type="button"
                  className="add-button-update"
                  onClick={(e) => {onAddItem('generalSkills', newSkill);
                  setNewSkill('');}}
                >
                  <Text label={"Add"} size={"s14"} weight={"regular"} />
                </button>
              ...
              <div className="tags-div">
                  {formData.generalSkills.map((skills, index) => (
                    <div className="tags-list">
                    <div key={index}><Text label={skills} size={"s14"} weight={"regular"} /></div>
                    <button
            type="button"
            className="remove-list-button"
          ...
          <div className="link">
            ...
            <img src={down} className="img" alt="down-icon" style={isLinkCollapsed ? {rotate: '0deg'} : {rotate: '180deg'}}/>
            </div>
            <hr />
            {!isLinkCollapsed && (
              <>
              <div className="inputbox-update">
                ...
                <button
                  type="button"
                  className="add-button-update"
                  onClick={() => {onAddItem('links', newLink);
                  setNewLink('');}}
                >
                  <Text label={"Add"} size={"s14"} weight={"regular"} />
                </button>
              ...
              <div className="requirements-list">
                <div className="tags-div">
                  {formData.links.map((link, index) => (
                    <div className="tags-list">
                    <div key={index}><Text label={link} size={"s14"} weight={"regular"} color={"black"} /></div>
                    <button
            type="button"
            className="remove-list-button"
          ...
          <button className="cancel-button">
            <Link className="cancel-link" to="/profile">Cancel</Link>
          </button>
          </div>
        </form>
      </div>
